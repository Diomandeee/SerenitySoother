...
from app.response.interface import IChainFactory
from app.chain_tree.schemas import Content, Chain, ChainCoordinate
...
class ChainFactory(IChainFactory):
    ...
    def register_chain_class(cls, chain_type: str, chain_class: Type[Chain]):
        ...
        if chain_type in cls.chain_classes:
            log_handler(f"Overwriting existing chain type: {chain_type}")

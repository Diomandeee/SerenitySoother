...
from chain_tree.response.builder import ReplyChainBuilder
from chain_tree.response.technique import SynthesisTechniqueDirector
from chain_tree.response.director import ReplyChainDirector
from chain_tree.models import get_token_ids, reverse_tokenize
...
class ReplyChainSystem:
    ...
    def __init__(
        ...
        register_synthesis_technique: Optional[SynthesisTechnique] = None,
    ):
        """
    ...
    def _truncate_conversation(
        ...
        if token_count > TOTAL_MAX_TOKEN_COUNT:
            ...
            tokens_to_remove_per_chain = np.ceil(
